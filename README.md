...
Bash
# Chặn (DROP) lập tức các địa chỉ IP mở nhiều hơn 20 kết nối đồng thời vào cổng 80
sudo iptables -A INPUT -p tcp --dport 80 -m connlimit --connlimit-above 20 -j DROP
Kết quả nghiệm thu: Các địa chỉ IP cố tình F5/Spam yêu cầu lập tức bị Tường lửa cắt đứt kết nối. Bảng giám sát htop cho thấy CPU hạ nhiệt nhanh chóng từ 100% về mức ổn định xanh mượt, dịch vụ Web được khôi phục.
